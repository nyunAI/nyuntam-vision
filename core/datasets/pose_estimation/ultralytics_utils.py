...
def create_ultralytics_folder_type(root, coco_dest_folder="coco_format_data"):
    ...
    val_ann_path = os.path.join(root, "annotations", "person_keypoints_val2017.json")
...
def make_labels(root, ann_file, folname, coco_dest_folder):
    ...
    def normalize_keypoints(coco, id, keypoints):
        image_info = coco.loadImgs(id)[0]
        img_width = image_info["width"]
        img_height = image_info["height"]
    ...
    for annotation in coco.dataset["annotations"]:
        ...
        keypoints = normalize_keypoints(coco, image_id, keypoints)
    ...
    for k in id_boxes.keys():
        ...
        with open(
            ...
            for bb in box:
                ...
                keypoints_string = " ".join([str(i) for i in bb[5:]])  # Keypoints
                string_box.append(bbox_string + " " + keypoints_string + "\n")
